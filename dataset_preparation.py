...
for dirname, _, filenames in os.walk(r'D:\ASL Recognition using CNN\Dataset'):
...
# train_image_directory = Path(r'D:\ASL Recognition using CNN\Dataset\asl_alphabets\asl_alphabet_train')
# # Note: always give full path for glob() function
# train_filepaths = list(train_image_directory.glob(r'*\*.jpg'))


# test_image_directory = Path(r'D:\ASL Recognition using CNN\Dataset\asl_alphabets\asl_alphabet_test')
